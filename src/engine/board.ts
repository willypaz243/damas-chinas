...
export class HexBoard {
  ...
  private static readonly TRIANGLE_CELLS: HexCoord[][] = [
    // Point 0 - Sur (bottom) - r >= 5
    [
      { q: -4, r: 5 }, { q: -3, r: 5 }, { q: -2, r: 5 }, { q: -1, r: 5 }, { q: -4, r: 6 },
      { q: -3, r: 6 }, { q: -2, r: 6 }, { q: -4, r: 7 }, { q: -3, r: 7 }, { q: -4, r: 8 },
    ],
    // Point 1 - Norte (top) - r <= -5
    [
      { q: 1, r: -5 }, { q: 2, r: -5 }, { q: 3, r: -5 }, { q: 4, r: -5 }, { q: 2, r: -6 },
      { q: 3, r: -6 }, { q: 4, r: -6 }, { q: 3, r: -7 }, { q: 4, r: -7 }, { q: 4, r: -8 },
    ],
    // Point 2 - Noreste (right) - q >= 5
    [
      { q: 5, r: -4 }, { q: 5, r: -3 }, { q: 5, r: -2 }, { q: 5, r: -1 }, { q: 6, r: -4 },
      { q: 6, r: -3 }, { q: 6, r: -2 }, { q: 7, r: -4 }, { q: 7, r: -3 }, { q: 8, r: -4 },
    ],
    // Point 3 - Suroeste (left) - q <= -5
    [
      { q: -5, r: 4 }, { q: -5, r: 3 }, { q: -5, r: 2 }, { q: -5, r: 1 }, { q: -6, r: 4 },
      { q: -6, r: 3 }, { q: -6, r: 2 }, { q: -7, r: 4 }, { q: -7, r: 3 }, { q: -8, r: 4 },
    ],
    // Point 4 - Sureste (bottom-right) - s = -q-r >= 5
    [
      { q: -4, r: -4 }, { q: -4, r: -3 }, { q: -4, r: -2 }, { q: -4, r: -1 }, { q: -3, r: -4 },
      { q: -3, r: -3 }, { q: -3, r: -2 }, { q: -2, r: -4 }, { q: -2, r: -3 }, { q: -1, r: -4 },
    ],
    // Point 5 - Noroeste (top-left) - s = -q-r <= -5
    [
      { q: 4, r: 4 }, { q: 4, r: 3 }, { q: 4, r: 2 }, { q: 4, r: 1 }, { q: 3, r: 4 },
      { q: 3, r: 3 }, { q: 3, r: 2 }, { q: 2, r: 4 }, { q: 2, r: 3 }, { q: 1, r: 4 },
    ],
